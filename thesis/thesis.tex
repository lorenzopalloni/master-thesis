...
%--------------------------------------------------------------
\newcommand{\myItalianTitle}{Tecniche di ottimizzazione di reti neurali per la super risoluzione\xspace}
\newcommand{\myEnglishTitle}{Optimization techniques of deep learning models for super-resolution\xspace}
